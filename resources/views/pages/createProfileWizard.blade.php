                                        ...
                                        <div id="collapseOne3" class="collapse show" data-parent="#accordionExample3">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group fv-plugins-icon-container">
                                                    ...
                                                    <div id="subcategory_tagify" style="display: none;">
                                                        <input id="kt_tagify_subcategory" class="form-control subCategory"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="font-size-h6 font-weight-bolder text-dark">Total
                                            GPA</label>
                                        <input type="text" class="form-control " name="gpa" placeholder="Your gpa"
                                            value="{{old('gpa')}}" />
                                        @if ($errors->has('gpa'))
                ...
                <div class="form-group fv-plugins-icon-container">
                    <div class="col-9 col-form-label">
                        <label for="exampleTextarea">9. How many working hours per week?
                            <input type="text" class=" form-control " name="hours" placeholder="enter your work hours"
                                rows="1" />
                    </div>
                </div>
                <div class="fv-plugins-message-container"></div>
