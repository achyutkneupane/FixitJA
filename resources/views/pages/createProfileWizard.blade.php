                ...
                <div class="wizard wizard-1" id="kt_wizard" data-wizard-state="first" data-wizard-clickable="false">
                        ...
                        <div class="wizard-steps p-8 p-lg-10">
                            ...
                            <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                <div class="wizard-label">
                                    ...
                                    <h3 class="wizard-title">1. Enter Address</h3>
                                </div>
                            ...
                            <div class="wizard-step" data-wizard-type="step" data-wizard-state="pending">
                                <div class="wizard-label">
                                    ...
                                    <h3 class="wizard-title">2. Enter Your Experince</h3>
                                </div>
                                <span class="svg-icon svg-icon-xl wizard-arrow">
                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Navigation/Arrow-right.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <div class="wizard-step" data-wizard-type="step" data-wizard-state="pending">
                                <div class="wizard-label">
                                    ...
                                    <h3 class="wizard-title">3. Select Report</h3>
                                </div>
                                <span class="svg-icon svg-icon-xl wizard-arrow">
                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Navigation/Arrow-right.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            <!--begin::Wizard Form-->
                            <form method="POST" class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form" enctype="multipart/form-data">
                            @csrf
                                <!--begin::Wizard Step 1-->
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    ...
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="street1" placeholder="Address Line 1" value="address1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="street2" placeholder="Address Line 2" value="address2">
                                        <span class="form-text text-muted">Please enter your Address.</span>
                                    </div>
                                    <!--end::Input-->
                                    <div class="row">
                                ...
                                <div class="pb-5" data-wizard-type="step-content">
                                    <h4 class="mb-10 font-weight-bold text-dark">Enter your experience</h4>
                                    <!--begin::Input-->
                                    <div class="form-group fv-plugins-icon-container">
                                        <label>Describe yourself</label>
                                        <textarea class="form-control" name="introduction" id="exampleTextarea" rows="3"></textarea>
                                        <span class="form-text text-muted">Please enter 100 words.</span>
                                        <div class="fv-plugins-message-container"></div>
                                    </div>
                                    <!--end::Input-->
                                    <!--begin::Input-->
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="areas_covering" placeholder="Package Weight" value="25">
                                    ...
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <input name="file" class="form-control form-control-solid form-control-lg" type="file" multiple />
                                        <span class="form-text text-muted">Please area of covering.</span>
                                        <div class="fv-plugins-message-container"></div>
                                    </div>
                                    <!--end::Input-->
                                ...
                                <!--begin::Wizard Step 3-->
                                <div class="pb-5" data-wizard-type="step-content">
                                    <h4 class="mb-10 font-weight-bold text-dark">Select Report</h4>
                                    <!--begin::Select-->
                                    <div class="form-group fv-plugins-icon-container">
                                        <label>Do you have Police Report?</label>
                                        <div class="radio-inline">
																<label class="radio radio-primary">
																<input type="radio" name="is_police_record" />
																<span></span>Yes</label>
																<label class="radio radio-primary">
																<input type="radio" name="is_police_record"/>
																<span></span>No</label>
                                    ...
                                    <div class="form-group fv-plugins-icon-container">
                                        <label>Do you have need travel?</label>
                                        <div class="radio-inline">
																<label class="radio radio-primary">
