                    ...
                    <div class="card-website-body d-flex-website">
                        <div class="d-flex-website flex-column-website align-items-start flex-grow-1">
                            <div class="flex-grow-1">
                                <a href="{{ route('aboutUs') }}" class="text-white font-weight-bolder font-size-h3">{{ $statics->where('slug','how_fixitja_works')->first()->title }}</a>
                                    {!! $statics->where('slug','how_fixitja_works')->first()->content !!}
                            </div>
                            <a href="{{ route('aboutUs') }}" class="btn btn-link btn-link-white font-weight-bold">Read More
