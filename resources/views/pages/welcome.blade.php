        ...
        <main>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b bg-primary" style="background-image: url({{asset('media/svg/patterns/taieri.svg')}})">
            ...
            <section class="bg-dark py-10">
                <div class="container">
                    ...
                    <div class="col-xl-12">
                            <!--begin::Tiles Widget 25-->
                            <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b" style="background-color:#663259; background-image: url({{asset('media/svg/patterns/taieri.svg')}})">
                                <div class="card-body d-flex">
                                    <div class="d-flex flex-column align-items-start flex-grow-1">
                                        <div class="flex-grow-1">
