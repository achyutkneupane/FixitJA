                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-6" data-aos="fade-up">
                                    ...
                                    <a class="btn btn-teal font-weight-500 mr-2" href="index.html">View Pages<i class="ml-2" data-feather="arrow-right"></i></a><a class="btn btn-link" href="https://docs.startbootstrap.com/sb-ui-kit-pro/quickstart">Documentation</a>
                                </div>
                                <div class="col-lg-6 d-none d-lg-block" data-aos="fade-up" data-aos-delay="100"><img class="img-fluid" src="{{asset('images/website/windows.svg')}}" /></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-md-9 col-lg-6 order-1 order-lg-0" data-aos="fade-right">
                                <div class="content-skewed content-skewed-right"><img class="content-skewed-item img-fluid shadow-lg rounded-lg" src="{{asset('images/website/landing-portfolio.png')}}" alt="..." /></div>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-lg-8">
                                ...
                                <a class="btn btn-teal font-weight-500" href="#!">Buy Now!</a>
                            </div>
                        </div>
                    </div>
                    <div class="svg-border-rounded text-white">
                ...
                <section class="bg-light py-10">
                    <div class="container mt-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 text-lg-right"><a class="btn btn-primary font-weight-500 mr-3 my-2" href="#!">Contact Sales</a><a class="btn btn-white font-weight-500 my-2 shadow" href="#!">Create Account</a></div>
                        </div>
                    </div>
                </section>
                <hr class="m-0" />
