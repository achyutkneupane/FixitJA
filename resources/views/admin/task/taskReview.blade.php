...
@section('content')
    @php
    $page_title = 'Task Reviews';
    $taskReviewIsActive = 'true';
    @endphp
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card card-custom">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('postReviews',$task->id) }}" id="reviewForm">
                        @csrf
        ...
        function validateAndGo() {
            ...
            form.onsubmit = function() {
                ...
                if (text == "<p><br></p>") {
                    ...
                    var discussionText = document.querySelector('input[name=reviewText]');
