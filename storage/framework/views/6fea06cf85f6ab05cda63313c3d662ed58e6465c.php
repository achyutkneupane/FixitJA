        ...
        <?php else: ?>
            <div class="dropdown" id="kt_quick_search_toggle">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <?php echo $__env->make('demo1_layout.partials.extras.dropdown._search-dropdown', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <?php if(config('layout.extras.notifications.display')): ?>
        ...
        <?php else: ?>
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        <?php echo $__env->make('demo1_layout.partials.extras.dropdown._notifications', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </form>
                </div>
            </div>
        <?php endif; ?>
    ...
    <?php if(config('layout.extras.quick-actions.display')): ?>
        ...
        <?php else: ?>
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <?php echo $__env->make('demo1_layout.partials.extras.dropdown._quick-actions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <?php if(config('layout.extras.cart.display')): ?>
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                <form>
                    <?php echo $__env->make('demo1_layout.partials.extras.dropdown._cart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </form>
            </div>
        </div>
    <?php endif; ?>
    ...
    <?php if(config('layout.extras.languages.display')): ?>
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                <?php echo $__env->make('demo1_layout.partials.extras.dropdown._languages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    <?php endif; ?>
        ...
        <?php else: ?>
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    <?php echo $__env->make('demo1_layout.partials.extras.dropdown._user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        <?php endif; ?>
    <?php endif; ?>
</div>
<?php /**PATH C:\Apache24\htdocs\FixitJA\FixitJA-CBV-New\FixitJA\resources\views/demo1_layout/partials/extras/_topbar.blade.php ENDPATH**/ ?>