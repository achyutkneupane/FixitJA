                    ...
                    <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <select name="skills_category" subcatid="kt_tagify_subcategory" id="selected_catgeory1" class="form-control form-control-solid form-control-lg category-select">
                                                        ...
                                                        <option value="<?php echo e($cate->id); ?>"><?php echo e($cate->name); ?>
                        ...
                        <div class="pb-5" data-wizard-type="step-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control " name="educationinstutional_name" placeholder="Name" value="<?php echo e(old('educationinstutional_name')); ?>" />
                                <?php if($errors->has('educationinstutional_name')): ?>
                                <span class="text-danger"><?php echo e($errors->first('educationinstutional_name')); ?></span>
                                <?php endif; ?>
                            </div>
                            <!--begin::Form Group-->
                            <div class="form-group">
                                ...
                                <select class="form-control" id="degree_wizard_profile" name="degree" value="<?php echo e(old('degree')); ?>">
                        ...
                        <div class="pb-5" data-wizard-type="step-content">
                            ...
                            <div class="form-group fv-plugins-icon-container">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="image-input image-input-empty image-input-outline" id="kt_image_5" style="background-image: url(<?php echo e(asset('media/users/blank.png')); ?>);">
...
<link href="<?php echo e(asset('css/custom/create-profile-wizard-custom.css')); ?>" rel="stylesheet" type="text/css" />
...
<script src="<?php echo e(asset('js/custom/custom.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('js/custom/create-profile-wizard-custom.js')); ?>" type="text/javascript"></script>

<script src="<?php echo e(asset('js/custom/create-profile-tagify.js')); ?>" type="text/javascript"></script>

<script src="<?php echo e(asset('js/pages/custom/login/login-4.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('js/pages/crud/forms/widgets/bootstrap-daterangepicker.js')); ?>"></script>


<script src="<?php echo e(asset('js/custom/create-workingdays-tagify.js')); ?>" type="text/javascript"></script>
<<<<<<< HEAD
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Apache24\htdocs\FixitJA\FixitJA-CBV-New\FixitJA\resources\views/pages/createProfileWizard.blade.php ENDPATH**/ ?>