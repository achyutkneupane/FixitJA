...
<div id="kt_header" class="header <?php echo e(Metronic::printClasses('header', false)); ?>" <?php echo e(Metronic::printAttrs('header')); ?>>
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <?php echo $__env->make('demo1_layout.partials.extras._topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>
<?php /**PATH C:\Apache24\htdocs\FixitJA\FixitJA-CBV-New\FixitJA\resources\views/demo1_layout/base/_header.blade.php ENDPATH**/ ?>