...
<div class="aside aside-left <?php echo e(Metronic::printClasses('aside', false)); ?> d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto <?php echo e(Metronic::printClasses('brand', false)); ?>" id="kt_brand">
        <div class="brand-logo">
            <a href="<?php echo e(url('/')); ?>">
                <img alt="<?php echo e(config('app.name')); ?>" height="60px" src="<?php echo e(asset('images/logo.png')); ?>" />
            </a>
        </div>
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <?php endif; ?>
        <div id="kt_aside_menu" class="aside-menu my-4 <?php echo e(Metronic::printClasses('aside_menu', false)); ?>" data-menu-vertical="1" <?php echo e(Metronic::printAttrs('aside_menu')); ?>>
...
<?php /**PATH C:\Apache24\htdocs\FixitJA\FixitJA-CBV-New\FixitJA\resources\views/layouts/base/_aside.blade.php ENDPATH**/ ?>