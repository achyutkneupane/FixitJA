...
<?php if(!empty(session()->get('catId'))): ?>
<script>
var sessionCatId = <?php echo e(session()->get('catId')); ?>;
</script>
<?php elseif(!empty(session()->get('subCatId'))): ?>
<script>
var sessionCatId = 'NULL';
var sessionSubCatId = <?php echo e(session()->get('subCatId')); ?>;
var sessionsubCatCatId = <?php echo e($subs->find(session()->get('subCatId'))->category->id); ?>;
</script>
<?php endif; ?>
                ...
                <div class="wizard wizard-1" id="kt_wizard" data-wizard-state="first" data-wizard-clickable="false">
                    ...
                    <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            <!--begin::Wizard Form-->
                            <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form" method="POST" action="<?php echo e(route('addProject')); ?>">
                                <?php echo csrf_field(); ?>
                                <!--begin::Wizard Step 1-->
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <select id="categorySelectTemplate" subcatid="kt_tagify_subCat_project_wizard_Template" name="categoryTemplate" class="form-control form-control-solid form-control-sm project_category_select">
                                                                ...
                                                                <option value="<?php echo e($cat->id); ?>"><?php echo e(ucwords($cat->name)); ?></option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <input type="text" class="form-control form-control-solid form-control-sm" name="user_name" placeholder="Full Name" value="<?php echo e(!empty($user) ? $user->name : ''); ?>">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <input type="text" class="form-control form-control-solid form-control-sm" name="phone" placeholder="Phone" value="<?php echo e(!empty($user) ? $user->phone() : ''); ?>">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group fv-plugins-icon-container">
                                                <label>Email</label>
                                                <input type="text" class="form-control form-control-solid form-control-sm" name="email" placeholder="Email" value="<?php echo e(!empty($user) ? $user->email() : ''); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <input type="text" class="form-control form-control-solid form-control-sm" name="street_01" placeholder="Street Address 1" value="<?php echo e(!empty($user) ? $user->street_01 : ''); ?>">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <input type="text" class="form-control form-control-solid form-control-sm" name="street_02" placeholder="Street Address 2" value="<?php echo e(!empty($user) ? $user->street_02 : ''); ?>">
                                                <span class="form-text text-muted">Please enter your Street Address</span>
                                                <div class="fv-plugins-message-container"></div>
                                                <!--end::Input-->
                                            </div>
...
<link href="<?php echo e(asset('css/custom/create-project-wizard-custom.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopSection(); ?>

<?php $__env->startSection('scripts'); ?>
<script
    src="<?php echo e(asset('js/custom/create-project-wizard-custom.js')); ?>" type="text/javascript">
</script>
<script
    src="<?php echo e(asset('js/custom/create-project-tagify.js')); ?>" type="text/javascript">
</script>
<script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Apache24\htdocs\FixitJA\FixitJA-CBV-New\FixitJA\resources\views/pages/createTaskWizard.blade.php ENDPATH**/ ?>