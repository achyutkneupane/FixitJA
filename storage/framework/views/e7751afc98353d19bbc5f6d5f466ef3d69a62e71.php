                    ...
                    <div class="login-form">
                        <form method="POST" action="/forget-password">
                            ...
                            <div class="form-group d-flex flex-wrap">
                                ...
                                <a href="<?php echo e(route('login')); ?>" id="kt_login_forgot_cancel" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3">Cancel</a>
                            </div>
                            <!--end::Form group-->
                        </form>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Apache24\htdocs\FixitJA\FixitJA-CBV-New\FixitJA\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>