        ...
        <div class="container-website">
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-up">
                    ...
                    <form action="<?php echo e(route('categoryRequest')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                ...
                <div class="col-lg-6 d-none d-lg-block" data-aos="fade-up" data-aos-delay="100"><img class="img-fluid" src="<?php echo e(asset('images/website/mainbg.svg')); ?>" /></div>
            </div>
        </div>
    </div>
    ...
    <div class="container-website">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card-website card-website-custom bgi-no-repeat bgi-size-cover gutter-b bg-primary" style="background-image: url(<?php echo e(asset('images/website/repairman1.svg')); ?>)">
...
<section class="bg-light">
    <div class="pt-website-10 py-website-10">
        <div class="container-website" style="box-shadow: 0 0.15rem 1.75rem 0 rgb(33 40 50 / 15%);">
            ...
            <?php echo $__env->make('layouts.partials._team-members', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
...
<section class="bg-dark py-website-10">
    <div class="container-website">
        <div class="row">
            <div class="col-xl-12">
                <!--begin::Tiles Widget 25-->
                <div class="card-website card-website-custom bgi-no-repeat bgi-size-cover gutter-b" style="background-color:#663259; background-image: url(<?php echo e(asset('media/svg/patterns/taieri.svg')); ?>)">
                    <div class="card-website-body d-flex-website">
                        <div class="d-flex-website flex-column-website align-items-start flex-grow-1">
                            <div class="flex-grow-1">
                    ...
                    <div class="card-website-body py-website-5">
                        <div class="testimonial p-lg-5">
                            <div class="testimonial-brand text-gray-400">
                                <img src="<?php echo e(asset('images/cumbv-logo.png')); ?>" width="200px">
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Apache24\htdocs\FixitJA\FixitJA-CBV-New\FixitJA\resources\views/pages/welcome.blade.php ENDPATH**/ ?>