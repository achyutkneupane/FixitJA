        ...
        <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
                        ...
                        <form method="POST" action="<?php echo e(route('authenticate')); ?>">
                            ...
                            <div class="pb-5 pb-lg-15">
                                ...
                                <div class="text-muted font-weight-bold font-size-h4">New Here?
                                    <a href="<?php echo e(route('register')); ?>" class="text-primary font-weight-bolder">Create
                                        Account</a>
                                </div>
                            </div>
                            <!--begin::Title-->
            ...
            <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
                <div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom"
                    style="background-image: url(<?php echo e(asset('images/website/repair1.svg')); ?>);">
                    <!--begin::Aside title-->
                    <h3
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Apache24\htdocs\FixitJA\FixitJA-CBV-New\FixitJA\resources\views/auth/login.blade.php ENDPATH**/ ?>