...
$("#add_more_reference").click(function(e) {
    ...
    if ($(".card-reference-accordion").length < 3) {
        ...
        $("#accordion_reference").append(
            ...
            '<input type="text" id="refname" class="form-control"  type="text" name="referal_name' + count + '" placeholder="Referral Name" value="">' +
            '</label>' +
            '</div>' +
            '<div class="form-group">' +
            '<label class="font-size-h6 font-weight-bolder text-dark col-12">Referral Email<span class="text-muted lead">(Optional)</span>' +
            '<input type="email" id="refemail" class="form-control"  type="email" name="referal_email' + count + '" placeholder="Referral Email" value="">' +
            '</label>' +
            '</div>' +
            '<div class="form-group">' +
            '<label class="font-size-h6 font-weight-bolder text-dark col-12">Referral Contact Number' +
            '<input type="text" id="refphone" class="form-control"  type="text" name="referal_phone' + count + '" placeholder="Referral Contact Number" value="">' +
            '</label>' +
            '</div>' +
            ' <div class="fv-plugins-message-container"> ' +
            ' </div> ' +
