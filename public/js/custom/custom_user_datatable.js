    ...
    var datatable = $('#kt_datatable').KTDatatable({
      ...
      columns: [
        ...
        template: function template(row) {
          ...
          return '<span class="label label-' + status[row.Role].state + ' label-dot mr-2"></span><span class="font-weight-bold text-' + status[row.Role].state + '">' + status[row.Role].title + '</span>';
        }
      }, {
        field: 'Email',
        type: 'string',
